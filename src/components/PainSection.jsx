      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight px-2">
            ...
            <span className="text-white block mb-6">Além dos incêndios cotidianos, ela é fundamental na resolução de questões de alta complexidade, tais como:</span>
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-10 sm:mb-12">
          {cards.map((card, index) => (
            ...
            >
              {/* Border estática */}
              <div className="absolute -inset-[3px] rounded-2xl bg-gradient-to-br from-cyan-400/50 via-blue-500/50 to-cyan-400/50">
              </div>
              ...
              <div className="relative bg-slate-900 rounded-2xl p-6 sm:p-8 h-full">
                ...
                <div className="mb-4 sm:mb-6">
                  <card.icon className="text-cyan-400 text-3xl sm:text-4xl w-12 h-12" />
                </div>
